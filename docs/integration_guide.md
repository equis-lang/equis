...
To handle complex external bindings, ensure your host target (`clang` or `gcc`) links the corresponding symbols statically alongside the IR generated by Equis.
