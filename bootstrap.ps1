...
if ($LASTEXITCODE -ne 0) { Write-Error "Bootstrap Phase 1 failed: GCC compilation error."; exit 1 }
...
if ($LASTEXITCODE -ne 0) { Write-Error "Bootstrap Phase 2 failed: Compiler IR generation error."; exit 1 }
...
if ($LASTEXITCODE -ne 0) { Write-Error "Bootstrap Phase 4 failed: Clang compilation error."; exit 1 }
